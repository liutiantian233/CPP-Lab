 ...
 * converts it to a string (does not print to cout!!!)
 * uses width to space elements (size_t width). Default is 3
 */
string matrix_to_str(const matrix &m, size_t width = 3);
